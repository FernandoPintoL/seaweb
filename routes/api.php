...
Route::post('/appgaleriavisitante/queryRange', [GaleriaVisitanteController::class, 'queryRange'])->name('appgaleriavisitante.queryRange');
Route::post('/appgaleriavisitante/queryMayor', [GaleriaVisitanteController::class, 'queryMayor'])->name('appgaleriavisitante.queryMayor');
...
Route::post('/appgaleriavehiculo/queryRange', [GaleriaVehiculoController::class, 'queryRange'])->name('appgaleriavehiculo.queryRange');
Route::post('/appgaleriavehiculo/queryMayor', [GaleriaVehiculoController::class, 'queryMayor'])->name('appgaleriavehiculo.queryMayor');
