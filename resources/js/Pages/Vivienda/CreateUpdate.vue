        ...
        <FormSection v-else @submitted="sendModel">
            ...
            <template #form>
                ...
                <div class="col-span-12 sm:col-span-12">
                    ...
                    <TextInput id="nroVivienda" v-model="form.nroVivienda" type="text" class="mt-1 block w-full"
                        required autocomplete="nroVivienda" />
                    <InputError class="mt-2" :message="reactives.nroViviendaError.toUpperCase()" />
                </div>
                <!-- TIPO DE VIVIENDA -->
                <div class="col-span-12 sm:col-span-12">
                    <label for="tp_vivienda" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        Seleccione un tipo de vivienda
                    </label>

                    <select id="tp_vivienda" required
                        ...
                        <option v-for="item in reactives.list_tipos_viviendas" :key="item.id" :value="item.id">
                ...
                <!-- CONDOMINIO -->
                <div class="col-span-12 sm:col-span-12">
                    <label for="selects-condominios"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        Seleccione un Condominio
                    </label>

                    <select id="selects-condominios" required
                        class="custom bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        v-model="form.condominio_id">
                        <option v-for="item in reactives.list_condominios" :key="item.id" :value="item.id">
                ...
                <div class="col-span-12 sm:col-span-12">
                    <div class="flex items-center">
                        <input type="checkbox" id="vvd-ocupada" required
                        ...
                        <label for="vvd-ocupada" class="text-sm text-gray-500 ms-3 dark:text-neutral-400">
                            Vivienda Ocupada?
                        </label>
                    </div>
                </div>
                <!-- Detalle -->
                <div class="col-span-12 sm:col-span-12">
                    <label for="vivienda-detalle" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        Detalle
                    </label>
                    <textarea id="vivienda-detalle" autocomplete="detalle" v-model="form.detalle" rows="4"
