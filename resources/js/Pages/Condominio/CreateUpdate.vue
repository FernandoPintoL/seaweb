    ...
    <AppLayout title="CONDOMINIOS">
        ...
        <FormSection v-else @submitted="sendModel">
            ...
            <template #form>
                ...
                <div class="col-span-12 sm:col-span-12">
                    ...
                    <div class="flex">
                        ...
                        <input v-model="form.propietario" @input="onValidatePropietario" required type="text"
                            id="propietario"
                ...
                <div class="col-span-12 sm:col-span-12">
                    ...
                    <div class="flex">
                        ...
                        <input v-model="form.perfil.direccion" required @input="onValidateDireccion" type="text"
                            id="direccion"
                            class="rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Bonnie Green" />
                    </div>
            ...
            /> -->
                ...
                <!-- RAZON SOCIAL -->
                <div class="col-span-12 sm:col-span-12">
                    <label for="razonSocial" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        Razon Social
                    </label>
                    <div class="flex">
                        <span
                        ...
                        <input v-model="form.razonSocial" @input="onValidateRazonSocial" type="text" id="razonSocial"
                            class="rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Bonnie Green" />
                    </div>
                ...
                <div class="col-span-12 sm:col-span-12">
                    ...
                    <div class="flex">
                        ...
                        <input v-model="form.nit" @input="onValidateNroDocumento" type="text" id="nroDocumento"
                            class="rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div v-if="props.model == null" class="col-span-12 sm:col-span-12">
                    ...
                    <div class="flex">
                        ...
                        <input v-model="form.user.usernick" @input="onValidateUserNick" required type="text"
                            id="usernick"
                            class="rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="fpl3001" />
                    </div>
                ...
                <div v-if="props.model == null" class="col-span-12 sm:col-span-12">
                    ...
                    <div class="flex">
                        ...
                        <input v-model="form.user.email" @input="onValidateEmail" type="email" id="email"
                            class="rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div v-if="props.model == null" class="col-span-12 sm:col-span-12">
                    ...
                    <div class="flex">
                        ...
                        <input v-model="form.user.password" @input="onValidatePassword" name="password"
