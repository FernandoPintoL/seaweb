...
const destroyData = async (id) => {
  const url = route('condominio.destroy', id)
  await axios
    .delete(url)
    .then((response) => {
                    ...
                    <td class="h-px w-72 whitespace-nowrap">
                      <div class="px-6 py-3">
                        ...
                        <button
                          ...
                          v-if="
                            $page.props.user.roles.includes('super-admin') ||
                            $page.props.user.permissions.includes('CONDOMINIO.ELIMINAR') ||
                            $page.props.user.permissions_roles.includes('CONDOMINIO.ELIMINAR')
                          "
