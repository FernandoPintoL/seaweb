...
<template>
    <AppLayout title="Crear Vehiculo">
        <div class="w-full mr-4" v-show="props.model != null">
            <button v-if="$page.props.user.roles.includes('super-admin') ||
            ...
            " type="button" @click="changeShowGaleria" :class="reactives.showGaleria
                ...
                <FormSection @submitted="sendModel">
                    ...
                    <template #form>
                        ...
                        <div class="col-span-12 sm:col-span-12">
                            ...
                            <TextInput id="sigla" v-model="form.placa" type="text" class="mt-1 block w-full" required
                                autocomplete="sigla" @input="onValidatePlaca" />
                            <InputError class="mt-2" :message="reactives.placaError.toUpperCase()" />
                        ...
                        <!-- TIPO DE VEHICULO -->
                        <div class="col-span-12 sm:col-span-12">
                            <label for="tipo_vehiculos"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Seleccione un tipo de vehiculo
                            </label>

                            <select id="tipo_vehiculos" required
                        ...
                        <div class="col-span-12 sm:col-span-12">
                            ...
                            <TextInput id="detalle" v-model="form.detalle" type="text" class="mt-1 block w-full"
                                autocomplete="detalle" />
                            <InputError class="mt-2" :message="reactives.detalleError.toUpperCase()" />
