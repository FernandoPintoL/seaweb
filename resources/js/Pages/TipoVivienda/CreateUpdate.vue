...
<template>
    <AppLayout title="Tipo Vivienda">
        <template #header>
            <h2 v-if="props.model != null" class="font-semibold text-xl text-gray-800 leading-tight">
                ACTUALIZAR TIPO VIVIENDA
                {{ props.model.sigla != null ? '' : props.model.sigla }}
            </h2>
            ...
            <FormSection @submitted="sendModel">
                ...
                <template #form>
                    ...
                    <div class="col-span-12 sm:col-span-12">
                        ...
                        <TextInput id="sigla" v-model="form.sigla" type="text" class="mt-1 block w-full" required
                            autocomplete="sigla" @input="onValidateSigla" />
                        <InputError class="mt-2" :message="reactives.siglaError.toUpperCase()" />
                    ...
                    <div class="col-span-12 sm:col-span-12">
                        ...
                        <TextInput id="detalle" v-model="form.detalle" type="text" class="mt-1 block w-full" required
