...
<template>
  ...
  <div v-else>
    ...
    $page.props.user.roles.includes('GALERIA_VISITANTE.CREAR') ||
                $page.props.user.roles.includes('GALERIA_VISITANTE.EDITAR')
              "
    ...
    $page.props.user.roles.includes('GALERIA_VISITANTE.MOSTRAR')
          ...
          <button
            v-if="
                $page.props.user.roles.includes('super-admin') ||
    $page.props.user.roles.includes('GALERIA_VISITANTE.ELIMINAR')
              "
            type="button"
