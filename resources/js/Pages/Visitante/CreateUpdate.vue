...
<template>
    <AppLayout title="Craear Visitante">
        <div class="w-full mr-4" v-show="props.model != null">
            <button v-if="props.crear_galeria || props.editar_galeria || props.eliminar_galeria" type="button"
                @click="changeShowGaleria" :class="reactives.showGaleria
                ...
                <FormSection @submitted="sendModel">
                    ...
                    <template #form>
                        ...
                        <div class="col-span-12 sm:col-span-12">
                            ...
                            <InputError class="mt-2" :message="reactives.nameError.toUpperCase()" />
                        </div>

                        <!-- TIPO DE DOCUMENTO -->
                        <div class="col-span-12 sm:col-span-12">
                            <label for="select-tp-doc"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Seleccione un tipo de documento
                            </label>

                            <select id="select-tp-doc" required
                        ...
                        <div class="col-span-12 sm:col-span-12">
                            ...
                            <div class="flex">
                                ...
                                <input v-model="form.perfil.nroDocumento" @input="onValidateNroDocumento" required
                                    type="text" id="nroDocumento"
                                    class="rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="8887777-EXT" />
                            </div>
                            <InputError class="mt-2" :message="reactives.nroDocumentoError.toUpperCase()" />
                        </div>
                        <!-- Celular -->
                        <div class="col-span-12 sm:col-span-12">
                            ...
                            <InputError class="mt-2" :message="reactives.celularError.toUpperCase()" />
                        </div>
                    </template>
