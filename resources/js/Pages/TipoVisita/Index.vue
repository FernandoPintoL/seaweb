                  ...
                  <tr v-for="item in datas.list" :key="item.id">
                    ...
                    <td class="px-3 py-3">
                      <Link
                        ...
                        "
                        :href="route('tipovisita.edit', item.id)"
                      ...
                      <button
                        ...
                        v-if="
                          $page.props.user.roles.includes('super-admin') ||
                          $page.props.user.permissions.includes('TIPO_VISITA.ELIMINAR') ||
                          $page.props.user.permissions_roles.includes('TIPO_VISITA.ELIMINAR')
                        "
