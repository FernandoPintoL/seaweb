...
const queryList = async (consulta) => {
    datas.isLoad = true
    const url = route('permissions.query', {
                                ...
                                <template #tbl-body>
                                    <tr v-for="item in datas.list" :key="item.id">
                                        ...
                                        <td v-if="props.editar || props.eliminar" class="h-px w-72 whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <Link v-if="props.editar" :href="route('permissions.edit', item.id)"
                                                ...
                                                <button v-if="props.eliminar" type="button"
