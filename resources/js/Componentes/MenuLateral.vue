    ...
    <div id="hs-application-sidebar"
        ...
        <div class="relative flex flex-col h-full max-h-full">
            <div class="px-6 pt-4">
                <!-- Logo -->
                <div class="relative">
                    <img class="w-10 h-10 rounded-full" src="/assets/images/sealog.jpeg" alt="SEA" />
                </div>
                ...
                <nav class="hs-accordion-group p-3 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
                    <ul class="flex flex-col space-y-1">
                        ...
                        <li v-if="
                            ...
                            $page.props.user.permissions.includes('CONDOMINIOS.LISTAR') ||
                            $page.props.user.permissions.includes('CONDOMINIOS.MOSTRAR') ||
                            $page.props.user.permissions_roles.includes('CONDOMINIOS.LISTAR') ||
                            $page.props.user.permissions_roles.includes('CONDOMINIOS.MOSTRAR')
                        ">
                            <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-700 dark:text-neutral-200 dark:hover:text-neutral-300"
